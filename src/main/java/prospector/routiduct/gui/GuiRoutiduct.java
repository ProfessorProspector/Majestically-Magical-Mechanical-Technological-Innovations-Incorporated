...
import prospector.routiduct.gui.blueprint.GuiBlueprint;
import prospector.routiduct.gui.blueprint.element.ElementBase;
...
public class GuiRoutiduct extends GuiContainer implements IDynamicAdjustmentGUI {
	...
	protected void drawTitle() {
		Routiduct.proxy.getGuiAssembler().drawCenteredString(this, I18n.format(blueprint.tile.getBlockType().getUnlocalizedName() + ".name"), 6, 4210752);
	}
